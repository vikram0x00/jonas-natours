	...
	return (
		<div className="overflow-hidden m-2 max-w-96 flex flex-col rounded-2xl border bg-background">
			...
			<div className="px-4 py-2">
				...
				<p className="text-sm">Exploring the jaw-dropping US east coast by foot and by boat</p>
			</div>
			<div className="px-4 grid-cols-2 grid grid-rows-3 mb-2">
				...
				<div className="flex items-center mx-0.5 my-0.5 text-sm"><Star className="mr-1" size={16}/>4.1 (18)</div>
